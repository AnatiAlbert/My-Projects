    ...
    this.showArtist = function(obj){
        ...
        if(obj.results.length > 0){
            ...
            for(var i = 0; i < obj.results.length; i++){
                ...
                template+=     '<div class="item_thmb" style="background:url('+
                obj.results[i].artworkUrl100 +')"></div>'
                template+=     '<div class="item_title">'+ 
                obj.results[i].collectionName +'</div>'
                template+=     '<div class="item_price">'
                template+=         '<span>Price:</span>' + obj.results[i].
                collectionPrice
                template+=     '</div>'
